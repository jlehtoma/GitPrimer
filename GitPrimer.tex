...
\bi\item In the context of producing elaborate software to be released to the public the need for version control is self-evident
\item But why should we use it?\ei
\item Content Tracking System
\bi\item Useful for reports, manuscripts, web-sites, as well as software\ei
\ei
}
...
\item Hilarious yes, but perhaps not the best name for such a ubiquitous and powerful program
\ei
}
